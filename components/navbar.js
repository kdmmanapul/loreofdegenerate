...
export default function Home() {
  ...
  const [widthWindow, heightWindow, scrollPage] = useWindowSize();
  ...
  return (
    <div>
      <nav className={`${scrollPage > heightWindow / 3 ? "bg" : ""}`}>
        ...
        <div className="left">
          <ul className="social">
            <li>
              <a href="https://opensea.io/collection/loreofdegenerates" target="_blank">
            ...
            <li>
              <a href="https://twitter.com/LoreOfDegensNFT" target="_blank">
            ...
            <li>
              <a href="https://discord.gg/d92PnxAv" target="_blank">
          ...
          <label className="menu-icon">
            <input type="checkbox" defaultChecked={menu}
      ...
      <div className={menu ? "menu open" : "menu"}>
        <ul>
          {widthWindow < 1280 && links.map((e, i) => (
            <li key={i}>
              <a href={e.link} target="_blank">{e.name}</a>
            </li>
          ))}
